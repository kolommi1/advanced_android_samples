...
import cz.uhk.room_visualization.R;

public class RoomVisualizationMainActivity extends Activity {
    private static final String TAG = "AAS_roomVisualization";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_room_visualization__main);

        // nastavení OpenCV view
        viewOpenCv = (CameraBridgeViewBase) findViewById(R.id.opencv_surface_view);
        viewOpenCv.setVisibility(SurfaceView.VISIBLE);
        openCVCameraListener = new MyCvCameraViewListener(this);
       // viewOpenCv.setMaxFrameSize(640,480);
    ...
    public boolean checkPermissions(){
        ...
        for (String permission : permissions) {
            ...
            if (ContextCompat.checkSelfPermission(this, permission) != PackageManager.PERMISSION_GRANTED) {
                ...
                if (!ActivityCompat.shouldShowRequestPermissionRationale(RoomVisualizationMainActivity.this, permission)) {
                    boolean firstTimeRequest;
                    SharedPreferences sp = getSharedPreferences("AAS_room_visualization_prefferences", Activity.MODE_PRIVATE);
                    firstTimeRequest = sp.getBoolean("firstTimeRequest" + permission, true);
                    // první požadavak
                    if (firstTimeRequest) {
                        neededPermissions.add(permission);
                        sp = getSharedPreferences("AAS_room_visualization_prefferences", Activity.MODE_PRIVATE);
                ...
                if (!neededPermissions.isEmpty()) {
                    ...
                    ActivityCompat.requestPermissions(RoomVisualizationMainActivity.this, perms, 1000);
                }

                // zobrazení dialogu odkazující do nastavení aplikace
                if (displayDialog) {
                    ad = new AlertDialog.Builder(RoomVisualizationMainActivity.this)
